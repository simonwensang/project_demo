package com.project.mc.common.tenpay.util;
...
public class ConstantUtil {
	...
	//初始化
	//public static String APP_ID = "wxef412d23b6c44c25";//微信开发平台应用id
	//public static String APP_SECRET = "686a9fe826797a8875c5a82e39e16fe5";//应用对应的凭证
	//微信小程序
	public static String APP_ID = "wx70d4ded3fce5c9bf";//微信开发平台应用id
	public static String APP_SECRET = "60192051d672fe4a689d53375a00999f";//应用对应的凭证
	//服务号
	public static String APP_ID_NATIVE = "wxa0e6b78228d06592";
	public static String APP_SECRET_NATIVE = "91ac7e2aeeba24f171ef7a1361bc08ec";
	//应用对应的密钥
	//public static String APP_KEY = "kju7ygt5kjijhy798kju876gtr4k9876";
	//public static String PARTNER = "1492733342";//财付通商户号 1503456111
	public static String APP_KEY = "900150fe1b9cde5601a0eea116b0542d";
	public static String PARTNER = "1503456111";//财付通商户号
	...
	public static String WXACODE_URL = "https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=";
	public static String WXTOKEN_URL = "https://api.weixin.qq.com/cgi-bin/token";

	public static String JSCODE_URL = "https://api.weixin.qq.com/sns/jscode2session";
}
